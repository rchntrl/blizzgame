            ...
            <div data-ng-view="">
                <% if $Hero %>
                    ...
                    <div class="medium-9 columns">
                        <h3>Вступление</h3>
                        <ul id="intro-speech" class="hero-speech intro">
                    ...
                    <div class="medium-9 columns">
                        <h3>Хвастовство перед боем</h3>
                        <ul id="boast-speech" class="hero-speech intro">
                    ...
                    <div class="medium-9 columns">
                        <h3>Реплики при клике</h3>
                        <ul id="pissed-speech" class="hero-speech intro">
                    ...
                    <div class="medium-9 columns">
                        <h3>Реплики при убийстве</h3>
                        <ul id="kill-speech" class="hero-speech intro">
